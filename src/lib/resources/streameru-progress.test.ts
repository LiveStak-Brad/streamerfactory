...
describe("StreamerU progress and estimate sources of truth", () => {
  it("curriculum includes Content Creation, Growth, Community, Professional Creator, and Production Mastery and matches program lesson totals", () => {
    expect(CURRICULUM_TOTAL_LESSONS).toBe(94);
