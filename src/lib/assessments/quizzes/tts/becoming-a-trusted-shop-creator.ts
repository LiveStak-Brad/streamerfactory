...
export const quiz = lessonQuiz({
  lessonSlug: "becoming-a-trusted-shop-creator",
  programKey: "tts",
  title: "Quiz: Becoming a Trusted Shop Creator",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-02?", [
    ...
    question("q7", "Which evidence most strongly completes Becoming a Trusted Shop Creator Review?", [
      ["Completed shop-readiness-checklist, creator-onboarding-worksheet, profile-optimization-scorecard, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
