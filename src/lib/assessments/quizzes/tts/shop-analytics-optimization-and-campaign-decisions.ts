...
export const quiz = lessonQuiz({
  lessonSlug: "shop-analytics-optimization-and-campaign-decisions",
  programKey: "tts",
  title: "Quiz: Analytics, Optimization & Campaign Decisions",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-07?", [
    ...
    question("q7", "Which evidence most strongly completes Analytics, Optimization & Campaign Decisions Review?", [
      ["Completed shop-analytics-worksheet, campaign-decision-log, optimization-priority-card, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
