...
export const quiz = lessonQuiz({
  lessonSlug: "creating-product-videos-people-actually-watch",
  programKey: "tts",
  title: "Quiz: Creating Product Videos People Actually Watch",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-04?", [
    ...
    question("q7", "Which evidence most strongly completes Creating Product Videos People Actually Watch Review?", [
      ["Completed product-video-brief, review-comparison-planner, evergreen-product-series-map, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
