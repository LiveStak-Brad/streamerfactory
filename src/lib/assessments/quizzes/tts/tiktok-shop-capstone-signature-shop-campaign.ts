...
export const quiz = lessonQuiz({
  lessonSlug: "tiktok-shop-capstone-signature-shop-campaign",
  programKey: "tts",
  title: "Quiz: TikTok Shop Capstone: Signature Shop Campaign",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-10?", [
    ...
    question("q7", "Which evidence most strongly completes TikTok Shop Capstone: Signature Shop Campaign Review?", [
      ["Completed signature-shop-campaign-dossier, capstone-evidence-checklist-tiktok-shop, improvement-report-template-shop, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
