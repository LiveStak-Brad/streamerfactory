...
export const quiz = lessonQuiz({
  lessonSlug: "product-selection-research-and-affiliate-strategy",
  programKey: "tts",
  title: "Quiz: Product Selection, Research & Affiliate Strategy",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-03?", [
    ...
    question("q7", "Which evidence most strongly completes Product Selection, Research & Affiliate Strategy Review?", [
      ["Completed affiliate-evaluation-worksheet, product-research-scorecard, sample-request-planner, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
