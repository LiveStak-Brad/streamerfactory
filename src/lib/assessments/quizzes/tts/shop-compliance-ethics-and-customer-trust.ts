...
export const quiz = lessonQuiz({
  lessonSlug: "shop-compliance-ethics-and-customer-trust",
  programKey: "tts",
  title: "Quiz: Compliance, Ethics & Customer Trust",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-08?", [
    ...
    question("q7", "Which evidence most strongly completes Compliance, Ethics & Customer Trust Review?", [
      ["Completed shop-compliance-checklist, disclosure-script-bank-shop, claim-safety-scorecard, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
