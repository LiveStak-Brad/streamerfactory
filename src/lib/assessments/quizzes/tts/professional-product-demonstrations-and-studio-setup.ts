...
export const quiz = lessonQuiz({
  lessonSlug: "professional-product-demonstrations-and-studio-setup",
  programKey: "tts",
  title: "Quiz: Professional Product Demonstrations & Studio Setup",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-06?", [
    ...
    question("q7", "Which evidence most strongly completes Professional Product Demonstrations & Studio Setup Review?", [
      ["Completed product-demo-planner, tabletop-studio-checklist, multi-angle-demo-card, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
