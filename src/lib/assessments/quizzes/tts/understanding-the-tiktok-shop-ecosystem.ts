...
export const quiz = lessonQuiz({
  lessonSlug: "understanding-the-tiktok-shop-ecosystem",
  programKey: "tts",
  title: "Quiz: Understanding the TikTok Shop Ecosystem",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-01?", [
    ...
    question("q7", "Which evidence most strongly completes Understanding the TikTok Shop Ecosystem Review?", [
      ["Completed shop-ecosystem-map, role-boundary-checklist, creator-path-decision-card, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
