...
export const quiz = lessonQuiz({
  lessonSlug: "scaling-your-tiktok-shop-business",
  programKey: "tts",
  title: "Quiz: Scaling Your TikTok Shop Business",
  questions: [
    question("q1", "A creator wants to say a product \"guarantees\" a benefit they cannot verify. What best applies in TTS-09?", [
    ...
    question("q7", "Which evidence most strongly completes Scaling Your TikTok Shop Business Review?", [
      ["Completed seasonal-campaign-planner, customer-follow-up-guide-shop, shop-scale-system-card, a rehearsal or review note, and one specific improvement.", true, "Correct — it protects accurate Shop execution, customer trust, and evidence a reviewer can inspect."],
