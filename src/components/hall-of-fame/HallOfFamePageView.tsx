...
export async function HallOfFamePageView() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0b0a12] text-zinc-50">
      <div
      ...
      <header className="relative border-b border-white/10 px-5 py-12 text-center sm:px-8 sm:py-16">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-zinc-400">
          Celebrate creators, preserve network history, and compete for a permanent place in Streamer
          Factory lore.
        </p>
