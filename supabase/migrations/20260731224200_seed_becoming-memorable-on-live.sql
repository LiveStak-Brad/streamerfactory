-- Seed Content Creation Mastery lesson so /streameru/becoming-memorable-on-live resolves.
...
begin
  ...
  if seed_author is null then
    raise notice 'Skipping Content Creation lesson seed (becoming-memorable-on-live): no auth.users row.';
    return;
  end if;
  ...
  insert into public.resource_posts (
    ...
    'becoming-memorable-on-live',
    'Design three signature elements viewers can describe to a friend — moments, phrases, cues, and emotional texture.',
    $cc242$
## Introduction
