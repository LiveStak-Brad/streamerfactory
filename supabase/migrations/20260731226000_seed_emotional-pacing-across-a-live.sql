-- Seed Presence Mastery lesson so /streameru/emotional-pacing-across-a-live resolves.
...
begin
  ...
  if seed_author is null then
    raise notice 'Skipping Presence lesson seed (emotional-pacing-across-a-live): no auth.users row.';
    return;
  end if;
  ...
  insert into public.resource_posts (
    ...
    'emotional-pacing-across-a-live',
    'Plan peaks, rests, and recovery beats across a real LIVE energy arc.',
    $pr6000$
## Introduction
