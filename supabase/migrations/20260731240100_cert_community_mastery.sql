-- Community Mastery Certificate definition.
...
values (
  'cert_community_mastery',
  'Community Mastery Certificate',
  'Completed Community Mastery lessons, quizzes, LIVE missions, Capstone, and Program Final — belonging culture and healthy community systems for TikTok LIVE.',
  'community',
  '/branding/badges/elite.svg',
  '{"type":"complete_module","params":{"module":"community"}}'::jsonb,
  80,
  true
)
