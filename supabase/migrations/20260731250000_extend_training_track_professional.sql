-- Allow Professional Creator Mastery lessons to use training_track = 'professional'.
...
comment on column public.resource_posts.training_track is
  'Program track: beginner, battles, monetization, rules, content, presence, creation, growth, community, professional.';
