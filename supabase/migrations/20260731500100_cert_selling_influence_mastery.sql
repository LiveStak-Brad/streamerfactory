-- Selling & Influence Mastery Certificate definition.
...
values (
  'cert_selling_influence_mastery', 'Selling & Influence Mastery Certificate',
  'Completed Selling & Influence Mastery lessons, quizzes, LIVE missions, Ethical Creator Offer Capstone, and Program Final. Advanced Creator required before certificate award. Optional specialty; Honors never gates.',
  'selling', '/branding/badges/elite.svg',
  '{"type":"complete_module","params":{"module":"selling"}}'::jsonb, 160, true
)
