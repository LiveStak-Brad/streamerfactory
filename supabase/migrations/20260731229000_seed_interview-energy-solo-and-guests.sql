-- Seed Presence Mastery lesson so /streameru/interview-energy-solo-and-guests resolves.
...
begin
  ...
  if seed_author is null then
    raise notice 'Skipping Presence lesson seed (interview-energy-solo-and-guests): no auth.users row.';
    return;
  end if;
  ...
  insert into public.resource_posts (
    ...
    'Interview Energy (Solo and With Guests)',
    'interview-energy-solo-and-guests',
    'Host a 10-minute interview-style segment with listening and follow-ups.',
    $pr9000$
## Introduction
